...
mixin _$ListeningScreenState {
 ...
 bool get isListening; ContextType get detectedContext; int get sessionTimer; int get nextQuestionCountdown; bool get isQuestionReady; bool get isSessionEnded; List<String> get textChunks; String get latestTextChunk;
...
@override
int get hashCode => Object.hash(runtimeType,isListening,detectedContext,sessionTimer,nextQuestionCountdown,isQuestionReady,isSessionEnded,const DeepCollectionEquality().hash(textChunks),latestTextChunk);

@override
String toString() {
  return 'ListeningScreenState(isListening: $isListening, detectedContext: $detectedContext, sessionTimer: $sessionTimer, nextQuestionCountdown: $nextQuestionCountdown, isQuestionReady: $isQuestionReady, isSessionEnded: $isSessionEnded, textChunks: $textChunks, latestTextChunk: $latestTextChunk)';
}
...
@useResult
$Res call({
 bool isListening, ContextType detectedContext, int sessionTimer, int nextQuestionCountdown, bool isQuestionReady, bool isSessionEnded, List<String> textChunks, String latestTextChunk
});
...
/// Create a copy of ListeningScreenState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? isListening = null,Object? detectedContext = null,Object? sessionTimer = null,Object? nextQuestionCountdown = null,Object? isQuestionReady = null,Object? isSessionEnded = null,Object? textChunks = null,Object? latestTextChunk = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool isListening,  ContextType detectedContext,  int sessionTimer,  int nextQuestionCountdown,  bool isQuestionReady,  bool isSessionEnded,  List<String> textChunks,  String latestTextChunk)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ListeningScreenState() when $default != null:
return $default(_that.isListening,_that.detectedContext,_that.sessionTimer,_that.nextQuestionCountdown,_that.isQuestionReady,_that.isSessionEnded,_that.textChunks,_that.latestTextChunk);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool isListening,  ContextType detectedContext,  int sessionTimer,  int nextQuestionCountdown,  bool isQuestionReady,  bool isSessionEnded,  List<String> textChunks,  String latestTextChunk)  $default,) {final _that = this;
switch (_that) {
case _ListeningScreenState():
return $default(_that.isListening,_that.detectedContext,_that.sessionTimer,_that.nextQuestionCountdown,_that.isQuestionReady,_that.isSessionEnded,_that.textChunks,_that.latestTextChunk);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool isListening,  ContextType detectedContext,  int sessionTimer,  int nextQuestionCountdown,  bool isQuestionReady,  bool isSessionEnded,  List<String> textChunks,  String latestTextChunk)?  $default,) {final _that = this;
switch (_that) {
case _ListeningScreenState() when $default != null:
return $default(_that.isListening,_that.detectedContext,_that.sessionTimer,_that.nextQuestionCountdown,_that.isQuestionReady,_that.isSessionEnded,_that.textChunks,_that.latestTextChunk);case _:
  return null;
...
class _ListeningScreenState extends ListeningScreenState {
  const _ListeningScreenState({this.isListening = true, this.detectedContext = ContextType.podcast, this.sessionTimer = 0, this.nextQuestionCountdown = 15, this.isQuestionReady = false, this.isSessionEnded = false, final  List<String> textChunks = const [], this.latestTextChunk = ''}): _textChunks = textChunks,super._();
...
@override
int get hashCode => Object.hash(runtimeType,isListening,detectedContext,sessionTimer,nextQuestionCountdown,isQuestionReady,isSessionEnded,const DeepCollectionEquality().hash(_textChunks),latestTextChunk);
...
/// Create a copy of ListeningScreenState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? isListening = null,Object? detectedContext = null,Object? sessionTimer = null,Object? nextQuestionCountdown = null,Object? isQuestionReady = null,Object? isSessionEnded = null,Object? textChunks = null,Object? latestTextChunk = null,}) {
